                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span>Telefon Numarası: </span><a href="#">0538 830 3992</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            ...
                                            <div class="setting ht-setting">
                                                <ul class="ht-setting-list">
                                                    <li><a href="login-register.html">Profilim</a></li>
                                                    <li><a href="checkout.html">Kontrol</a></li>
                                                    <li><a href="login-register.html">Giriş</a></li>
                                                </ul>
                                            </div>
                                        </li>
                                        ...
                                        <!-- Begin Currency Area -->
                                        <li>
                                            <span class="currency-selector-wrapper">Birim :</span>
